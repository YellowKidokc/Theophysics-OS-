@echo off
setlocal
title River FIS - Simple GUI

set "PORT=8450"
set "URL=http://127.0.0.1:%PORT%/simple"

cd /d "%~dp0"

echo.
echo  River FIS - Simple GUI
echo  Starting local file intelligence dashboard...
echo.
...
if not exist "simple.html" (
    echo  simple.html is missing from this folder.
    pause
    exit /b 1
)
